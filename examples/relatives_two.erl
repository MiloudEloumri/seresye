...
%%%
%%%-------------------------------------------------------------------
%%% @doc seresye relatives two example.
%%% @version 0.0.5.
%%% Updated : 17. Nov 2021 8:11 AM.
%%%
%%% @end
%%%-------------------------------------------------------------------
-module(relatives_two).
...
start() ->
  ...
  seresye_srv:start(relatives_two),
  seresye_srv:add_rules(relatives_two, ?MODULE),

  seresye_srv:assert(relatives_two,
    [{male, bob},
      {male, corrado},
      {male, mark},
      {male, caesar},
