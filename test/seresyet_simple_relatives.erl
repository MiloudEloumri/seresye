...
%%%
%%%-------------------------------------------------------------------
%%% @doc seresye simple relatives example eunit test
%%%
%%% @version 0.0.5.
...
-export([father/3, grandfather/3, grandmother/3, mother/3]).
...
-rules([{grandfather, 10}, grandmother]).
...
rules_test() ->
    ...
    Engine2 =
        lists:foldl(fun(X, Engine1) -> seresye_engine:add_rule(Engine1, {?MODULE, X}) end,
                    Engine0,
